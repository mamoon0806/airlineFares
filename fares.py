...
browser = webdriver.Firefox(executable_path='C:/Users/mamoo/Downloads/geckodriver.exe')

#Setting ticket types paths

return_ticket = "//label[@id='flight-type-roundtrip-label-flp']"

one_way_ticket = "//label[@id='flight-type-one-way-label-flp']"

multi_ticket = "//label[@id='flight-type-multi-dest-label-flp']"
...
def dep_country_chooser(dep_country):
	...
	fly_from = browser.find_element_by_xpath("//input[@id='flight-origin-flp']")
	...
	first_item = browser.find_element_by_xpath("//a[@id='aria-option-1']")
...
def arrival_country_chooser(arrival_country):
	...
	fly_from = browser.find_element_by_xpath("//input[@id='flight-destination-flp']")
	...
	fly_from.send_keys('  ' + arrival_country)
...
def send_email(msg):
    ...
    message['From'] = 'mamoon0806@gmail.com'

    message['to'] = 'mamoon0806@gmail.com'
...
depMonth = input('Departure Month (2digit): ')
depDay = input('Departure Day (2digit): ')
depYear = input('Departure Year (4digit): ')
dep_date_chooser(depMonth, depDay, depYear)

arrMonth = input('Arrival Month (2digit): ')
arrDay = input('Arrival Day (2digit): ')
arrYear = input('Arrival Year (4digit): ')
return_date_chooser(arrMonth, arrDay, arrYear)
